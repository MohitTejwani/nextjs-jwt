...
export default function Layout({
  children,
  title = 'Next.js with JWT Authentication | A boilerplate JWT Authentication and Next.js ',
  description = 'Next.js with JWT Authentication | A boilerplate JWT Authentication and Next.js ',
